...
public class ExampleMain {
    ...
    public static void main( String[] args ) throws IOException {
        ...
        try {
            ...
            example.createCriteria().andTitleEqualTo("Food");
            List<db.model.Categories> list3 = categoriesMapper.selectByExample(example);
            db.model.Categories categories3 = list3.get(0);
            System.out.println("Food ID is = " + categories3.getId());
